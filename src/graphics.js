...
export const CueTypeIds = {
	...
	Audio: 'audio',
	BigTime: 'big_time',
	BigTimeCountdown: 'big_time_countdown',
	BigTimeCountup: 'big_time_countup',
	BigTimeToTod: 'big_time_to_tod',
	...
	UtilityLargeText: 'utility_large_text',
	UtilityPattern: 'utility_pattern',
	UtilitySpeakerTimer: 'utility_speaker_timer',
	UtilityTimeOfDay: 'utility_time_of_day',
	Video: 'video',
	Webpage: 'webpage',
}
...
const emptyPNG =
	'iVBORw0KGgoAAAANSUhEUgAAAEgAAAA6CAYAAAATBx+NAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAmSURBVHgB7cABAQAAAIIg/69uSFAAAAAAAAAAAAAAAAAAAAAArwZBegAB2I2aJAAAAABJRU5ErkJggg=='
...
export const CueTypes = {
	...
	[CueTypeIds.Time]: {
		...
		bgColor: combineRgb(248, 113, 113),
		label(cue) {
	...
	[CueTypeIds.Ticker]: {
		...
		bgColor: combineRgb(165, 180, 252),
		label(cue) {
	...
	[CueTypeIds.Checklist]: {
		...
		bgColor: combineRgb(100, 102, 237),
		label(cue) {
