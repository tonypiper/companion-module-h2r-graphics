...
export const graphicColours = (graphic) => {
	const graphicColors = {
		lower_third: [202, 138, 4],
		message: [234, 179, 8],
		time: [248, 113, 113],
		time_countdown: [248, 113, 113],
		time_countup: [248, 113, 113],
		time_tod: [248, 113, 113],
		time_to_tod: [248, 113, 113],
		image: [37, 99, 235],
		ticker: [165, 180, 252],
		social: [126, 34, 206],
		webpage: [55, 48, 163],
		score: [34, 197, 94],
		big_time: [248, 113, 113],
		lower_third_animated: [250, 204, 21],
		icon_with_message: [234, 179, 8],
		credits: [34, 197, 94],
		video: [80, 74, 226],
		image_with_message: [150, 103, 28],
		animated_background: [67, 102, 232],
		celebration: [111, 41, 203],
		now_next_then: [50, 87, 68],
		qr: [53, 88, 52],
		checklist: [100, 102, 237],
		map: [45, 60, 135],
		default: [0, 0, 0],
	}

	const bgColour = graphicColors[graphic] || graphicColors.default
...
export const replaceWithDataSource = (text, dynamicText, keepBrakets = false) => {
	...
	match.forEach((m) => {
		...
		array2.splice(index, 0, keepBrakets ? `[${returnString || 'Not set'}]` : returnString)
	})
